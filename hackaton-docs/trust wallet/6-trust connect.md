...
* [Quickstart](/developer/trustconnect/quickstart.md) — install, configure, and connect your first wallet
* [Modal & Connection Management](/developer/trustconnect/modal-and-connections.md) — control the connection modal and read wallet state
* [EVM (EIP-155)](/developer/trustconnect/evm.md) — sign messages, send transactions, and call contracts on Ethereum and EVM chains
* [Solana](/developer/trustconnect/solana.md) — sign messages and send transactions on Solana
* [Bitcoin (BIP-122)](/developer/trustconnect/bitcoin.md) — sign messages, PSBTs, and send transfers on Bitcoin
* [Theming & Customization](/developer/trustconnect/theming.md) — customize the UI theme or eject the full component set
