import { LayoutDashboard, Activity, LineChart, PieChart, Brain, Settings, ArrowDownToLine, ArrowUpFromLine, List, Users, Cpu, FileText, Bell, BookOpen } from "lucide-react";
